window.onload = function () {
    const buttonAdd = document.getElementsByClassName('adicionando-tarefa')[0];
    const buttonClear = document.getElementsByClassName('rmv-tarefas')[0];
    const buttonFinalizados = document.getElementsByClassName('rmv-executados')[0];
    const buttonSalve = document.getElementsByClassName('save')[0];
    const buttonRemove = document.getElementsByClassName('rmv-selecionado')[0]
    const buttonDown = document.getElementsByClassName('move-baixo')[0];
    const buttonUp = document.getElementsByClassName('move-cima')[0];
    const lista = document.getElementsByClassName('lista-ordenada')[0];
    const input1 = document.getElementsByClassName('tarefa')[0];
